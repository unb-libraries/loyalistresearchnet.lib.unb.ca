...
[![Build Status](https://travis-ci.com/unb-libraries/loyalistresearchnet.lib.unb.ca.svg?branch=prod)](https://travis-ci.com/unb-libraries/loyalistresearchnet.lib.unb.ca)
...
[![Docker image size](https://img.shields.io/docker/image-size/unblibraries/loyalistresearchnet.lib.unb.ca/prod?label=docker%20image%20size)](https://hub.docker.com/repository/docker/unblibraries/loyalistresearchnet.lib.unb.ca)
